  ...
  public function updateItem($itemId, $data)
{
    try {
        ...
        return [
            "status" => "success",
            "updated" => $stmt->rowCount(), // could be 0 if nothing changed
        ];
    } catch (PDOException $e) {
...
public function getItemById($itemId)
{
    ...
    if ($item) {
        ...
        $item['discount_id'] = $item['discount_id'] ? (int)$item['discount_id'] : null;
        $item['percentage'] = $item['percentage'] ? (float)$item['percentage'] : null;
