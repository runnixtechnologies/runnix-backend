  ...
  public function login($data)
{
    ...
    try {
        ...
        // If no mobile device data, collect basic web info
        if (empty($deviceData['device_id'])) {
            $deviceData = $this->collectBasicDeviceInfo();
        }
...
public function getStatus($user) {
    ...
    /**
     * Collect basic device info for web requests
     */
    private function collectBasicDeviceInfo()
    {
