...
class HttpRequestHandler{
    ...
    private function handle(){
        ...
        $this->allRequestBody = ($headers["Content-Type"] ?? '' == "application/json") ? json_decode(file_get_contents("php://input"), true) : array_merge($_GET, $_POST);
        // $requestData = ([
        //     "body" => arrayToObject($this->requestBody),
        //     "config" => arrayToObject($_SERVER),
        //     "headers" => arrayToObject($headers)
        // ]);
    }
