<?php
/**
 * Migration Script: Create food item configuration tables (LOCAL VERSION)
 * 
 * IMPORTANT: Update the database connection details below for your local environment
 * Run this script to create the tables needed for enhanced food item creation with sides, packs, and sections
 */

// ========================================
// UPDATE THESE SETTINGS FOR YOUR LOCAL DB
// ========================================
$local_host = "localhost";
$local_db_name = "runnix"; // Change this to your local database name
$local_username = "root";  // Change this to your local database username
$local_password = "";      // Change this to your local database password
// ========================================

try {
    // Create connection using local settings
    $conn = new PDO("mysql:host={$local_host};dbname={$local_db_name}", $local_username, $local_password);
    ...
    echo "\n💡 Make sure to update the database connection details at the top of this file!\n";
}
